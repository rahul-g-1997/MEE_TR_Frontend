export default function About() {
  return (
    <div>
      ...
      typesetting industry. Lorem Ipsum has been the s standard dummy text ever
      ...
      search for will uncover many web sites still in their infancy. Various
      versions have evolved over the years, sometimes by accident, sometimes on
      purpose injected humour and the like. Where does it come from? Contrary to
      ...
      from sections 1.10.32 and 1.10.33 of de Finibus Bonorum etThe Extremes of
      ...
      by H. Rackham. Where can I get some?What is Lorem Ipsum? Lorem Ipsum is
      simply dummy text of the printing and typesetting industry. Lorem Ipsum
      has been the s standard dummy text ever since the 1500s, when an unknown
      ...
      as opposed to using Content here, content making it look like readable
      English. Many desktop publishing packages and web page editors now use
      Lorem Ipsum as their default model text, and a search for will uncover
      ...
      the like. Where does it come from? Contrary to popular belief, Lorem Ipsum
      ...
      1.10.33 of de Finibus Bonorum etThe Extremes of Good and Evil by Cicero,
      ...
      Where can I get some?What is Lorem Ipsum? Lorem Ipsum is simply dummy text
      of the printing and typesetting industry. Lorem Ipsum has been the s
      ...
      using Content here, content making it look like readable English. Many
      ...
      de Finibus Bonorum etThe Extremes of Good and Evil by Cicero, written in
